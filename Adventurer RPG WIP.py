...
if a2 == "A":
	...
	im = Image.open(r"Screenshot from 2022-09-07 18-26-43.png")
	im.show()
	input("[Enter to continue] ")
	print("")
elif a2 == "D":
	...
	print("EROROROROROOR CRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR")
	exit()
...
a5 = input("")
if a5 == "A":
	print("You use your "+ weapon +", you damaged the bear and it seems badly injured, It ran away")
	print("but sadly you god a small scratch in the fight")
	print("-10 HP")
	health = health - 10
...
if chad == False:
	...
	time.sleep(1)
	im = Image.open(r"Crashed helicopter image")
	im.show()
	input("[Enter to Continue]")
...
if a8 == "Y":
	...
	time.sleep(2)
	im = Image.open(r"room with dead body image")
	im.show()
	input("[Enter to continue]")
	print("..")
...
if a10 == "Y":
	...
	im = Image.open(r"door to the outside world image")
	im.show()
	input("[Enter to Continue]")
else:
...
input("[Enter to Continue]")
im = Image.open(r"explode nuclear plant image")
im.show()
time.sleep(1)
...
time.sleep(1)
print("You just chose to sleep for the night.")